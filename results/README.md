...
- `tables/` — tabelas geradas (hiperparâmetros, comparativas, estatísticas — `docs/specs/SPEC-008-statistics.md`).
- `figures/` — figuras geradas (F1 macro/MCC, custo computacional, matrizes de confusão).
- `metadata/` — metadados de reprodutibilidade por experimento (`docs/protocols/reproducibility_protocol.md`), validados por `src/wp1a/tracking/metadata_guard.py`.
